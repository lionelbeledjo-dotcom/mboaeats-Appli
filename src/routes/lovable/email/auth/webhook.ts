...
const EMAIL_SUBJECTS: Record<string, string> = {
  signup: 'Votre code MboaEats',
  invite: 'Vous êtes invité sur MboaEats',
  magiclink: 'Votre code de connexion MboaEats',
  recovery: 'Réinitialisez votre mot de passe MboaEats',
