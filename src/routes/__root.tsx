...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "MboaEats — Le goût du Cameroun, livré chaud" },
      { property: "og:description", content: "L'application de livraison haut standing, pensée pour le Cameroun." },
