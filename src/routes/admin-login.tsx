...
function AdminLogin() {
  ...
  // Detect whether the system has any admin yet → first-launch flow.
  useEffect(() => {
    (async () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      if (mode === "bootstrap") {
        // Create the SUPER_ADMIN account on first launch.
        ...
        // Sign in immediately (works if email confirmation is off).
        ...
        >
          ...
          <div className="mt-1.5 flex items-center gap-2 rounded-xl border border-border bg-background px-3 py-2.5 focus-within:border-primary">
            ...
            <input
              ...
              placeholder="lionelbrown2728@yahoo.fr"
              required
            />
          </div>
          ...
          >
            ...
            {mode === "bootstrap" ? "Initialiser le compte propriétaire" : "Accéder à la console"}
          </button>
